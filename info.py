...
API_ID = int(environ.get('API_ID', '27258905'))
API_HASH = environ.get('API_HASH', '769d845b9d94d68686512c74d596ae60')
BOT_TOKEN = environ.get('BOT_TOKEN', "5957557143:AAHrhlmnnodAjou0jGIdCfA_xcFgrfSAkx0")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1247662397').split()]
